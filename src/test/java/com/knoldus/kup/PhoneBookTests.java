...
public class PhoneBookTests {
    ...
    public void findPhoneNumberByName_CorrectIfFound() {
        Optional<String> phoneNumber = phoneBookTest.findPhoneNumberByName("Aasif");
        assertThat(phoneNumber.get()).isEqualTo("8394012545");
    }
    ...
    public void findNameByPhoneNumber_CorrectIfFound(){
        ...
        assertThat(name.get()).isEqualTo("Azeem");
    }
